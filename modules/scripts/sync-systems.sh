...
## Workflow
1. Check for handoff documents in shared/handoffs/
2. If a handoff is addressed to you, read it and execute
3. When done, create a handoff back if follow-up is needed
4. Record your outcome: python3 mesh/learn.py record --system codex ...
...
2. If a handoff is addressed to you, read it and execute
3. When done, create a handoff back if follow-up is needed
4. Record your outcome: python3 mesh/learn.py record --system gemini ...
